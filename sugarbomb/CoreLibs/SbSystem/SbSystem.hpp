...
public:
	...
	LibHandle LoadLib(const char *asPath) override;
	void FreeLib(LibHandle anHandle) override;
	void *GetLibSymbol(LibHandle anHandle, const char *asSymbol) const override;
